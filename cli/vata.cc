...
int main(int argc, char **argv) {
    // for (int i=10; i<=50; i++) {
    //     auto aut = VATA::Util::TreeAutomata::basis_zero_one_zero(i);
    //     std::ofstream fileLhs("/home/alan23273850/libvata2/benchmarks/basis_zero_one_zero_" + std::to_string(i) + ".txt");
    ...
    //     if (!(n >= 2)) throw std::out_of_range("");
    //     aut = VATA::Util::TreeAutomata::basis_zero_one_zero(n);
    //     stateBefore = aut.stateNum, transitionBefore = aut.transition_size();
