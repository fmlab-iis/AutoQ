...
try {
    ...
    AUTOQ::Automata<AUTOQ::Symbol::Concrete> aut = AUTOQ::Parsing::TimbukParser<AUTOQ::Symbol::Concrete>::ReadAutomaton(pre);
    aut.remove_useless();
    aut.reduce();
    auto start = chrono::steady_clock::now();
    bool verify = aut.execute(circuit);
    AUTOQ::Automata<AUTOQ::Symbol::Concrete> Q = AUTOQ::Parsing::TimbukParser<AUTOQ::Symbol::Concrete>::ReadAutomaton(post);
    Q.remove_useless();
    Q.reduce();
