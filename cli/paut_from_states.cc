  ...
  -h, --help            show this help message and exit)" << std::endl;
    ...
    while (std::getline(*in, line)) {
        ...
        if (line.substr(0, 4) == "|i|=") { // if startswith "|i|="
            ...
            bool reach_all_zero;
            do {
                auto aut = TimbukParser<typename PredicateAutomata::InitialSymbol>::from_line_to_automaton(std::regex_replace(line, std::regex("i:"), i + ":"));
            ...
            auto aut = TimbukParser<typename PredicateAutomata::InitialSymbol>::from_line_to_automaton(line);
            aut_final = aut_final.Union(aut);
            aut_final.reduce();
        }
    }
