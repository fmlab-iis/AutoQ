...
def CTA(root, stR, semaphore, lock, counter):
    with semaphore:
        ...
        lock.acquire()
        counter.value+=1; print(counter.value, '/ 106')
        lock.release()
...
\midrule
  \multirow{12}{*}{\rotatebox[origin=c]{90}{\feynmanbench}}
''' +
  contents['feynmanbench'] +
r'''\midrule
  \multirow{20}{*}{\rotatebox[origin=c]{90}{\randombench}}
''' + 
  contents['randombench'] +
r'''\midrule
\multirow{21}{*}{\rotatebox[origin=c]{90}{\revlibbench}}
''' +
  contents['revlibbench'] +
r'''\bottomrule
\end{tabular}
}
