...
# Comprehensive script to create hardlinks for LSTA benchmarks
# This script can be run manually or called from git hooks

echo "Creating hardlinks for LSTA benchmarks..."
...
create_hardlinks_for_benchmark() {
    ...
    local target_dir="$REPO_ROOT/benchmarks/LSTA/$benchmark_name"
    ...
    # This is based on the existing LSTA structure
