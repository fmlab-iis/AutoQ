...
//         return symbol;
//     }
//     void fraction_simplification() { // TODO: Don't know if it is required or not.
//         if (at(0)==0 && at(1)==0 && at(2)==0 && at(3)==0) at(4) = 0;
//         else {
//             while ((at(0)&1)==0 && (at(1)&1)==0 && (at(2)&1)==0 && (at(3)&1)==0 && at(4)>=2) { // Notice the parentheses enclosing at(i)&1 are very important! HAHA
//                 for (int i=0; i<4; i++) at(i) /= 2;
...
//         }
//     }
//     int real() const { // temporarily fake solution but works for #qubit
//         return at(0).convert_to<int>();
//     }
//     int k() const { return at(4).convert_to<int>(); }
// };
