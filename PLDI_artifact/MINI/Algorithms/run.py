...
\newcommand{\groversingbench}[0]{\small\textsc{GS}\xspace}
\newcommand{\grovermultbench}[0]{\small\textsc{GA}\xspace}
\newcommand{\mctoffolibench}[0]{\small\textsc{MCT}\xspace}
...
\midrule
  \multirow{ 1}{*}{\rotatebox[origin=c]{0}{\bvbench}}
''' +
  content[0] + '\\\\\n' +
r'''\midrule
