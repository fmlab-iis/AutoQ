...
name = 'Table3.tex'
TIMEOUT = float(120) #(1800)
NUM_OF_THREADS = 1 #159
...
def AutoQ_permutation(root, stR, semaphore, lock, counter):
    with semaphore:
        ...
        lock.acquire()
        counter.value+=1; print(counter.value, '/ 18')
        lock.release()
...
\newcommand{\randombench}[0]{\small\textsc{Ra}\xspace}
\newcommand{\revlibbench}[0]{\small\textsc{Re}\xspace}
\newcommand{\feynmanbench}[0]{\small\textsc{Fe}\xspace}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\cmidrule[\heavyrulewidth](lr){11-19}
  ...
  & \multicolumn{1}{c}{\textbf{circuit}} & \multicolumn{1}{c}{\textbf{\#q}} & \multicolumn{1}{c}{\textbf{\#G}} & \multicolumn{1}{c}{\textbf{time}} & \textbf{bug?} & \multicolumn{1}{c}{\textbf{time}} & \textbf{bug?} & \multicolumn{1}{c}{\textbf{time}} & \textbf{bug?}
  &\multicolumn{1}{c}{\textbf{circuit}} & \multicolumn{1}{c}{\textbf{\#q}} & \multicolumn{1}{c}{\textbf{\#G}} & \multicolumn{1}{c}{\textbf{time}} & \textbf{bug?} & \multicolumn{1}{c}{\textbf{time}} & \textbf{bug?} & \multicolumn{1}{c}{\textbf{time}} & \textbf{bug?} \\

\cmidrule(lr){1-10}\cmidrule(lr){11-19}

  \multirow{ 1}{*}{\rotatebox[origin=c]{0}{\feynmanbench}}
''' +
'& ' + content[0] + ' & ' + content[1] + '\\\\\n' +
r'''\cmidrule(lr){1-10}\cmidrule(lr){11-19}

\multirow{ 1}{*}{\rotatebox[origin=c]{0}{\randombench}}
''' +
'& ' + content[2] + ' & ' + content[3] + '\\\\\n' +
r'''\cmidrule(lr){1-10}\cmidrule(lr){11-19}

\multirow{ 1}{*}{\rotatebox[origin=c]{0}{\revlibbench}}
''' +
'& ' + content[4] + ' & ' + content[5] + '\\\\\n' +
